...
const HeroSection = () => {
  return (
    <div className="w-full min-h-screen flex flex-col md:flex-row items-center justify-between px-25 bg-[#021c35] relative overflow-hidden">
      {/* Left Side */}
      <div className="flex flex-col gap-4 w-full md:w-145 text-center md:text-left mt-10 md:mt-0">
        ...
        <div className="flex flex-col gap-2">
          ...
          <span className="text-4xl md:text-6xl font-bold text-white">- Your Trusted</span>
          <span className="text-4xl md:text-6xl font-bold text-white">
            Healthcare Partner
          </span>
        </div>

        <div className="text-gray-400 w-full md:w-180">
      ...
      <div className="w-full md:w-auto mt-10 md:mt-0">
        <img src={image} alt="Doctor" className="w-full max-w-md mx-auto" />
      </div>
