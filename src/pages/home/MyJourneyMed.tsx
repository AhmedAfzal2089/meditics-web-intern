...
const MyJourneyMed = () => {
  return (
    <div className="flex flex-col lg:flex items-center gap-25 justify-center mt-20  ">
     ...
     <div className="flex flex-col w-full max-w-5xl gap-5 px-4 mx-auto">
  {/* Tagline */}
  <div>
  ...
  <span className="text-sm sm:text-base text-gray-600 text-center md:text-left">
    I'm Dr. Tushar Raja, a [Specialization, e.g., Internal Medicine Specialist] with a passion for providing holistic, evidence-based
    medical care. With over 12 years of experience, I’ve had the privilege of treating thousands of patients with empathy, accuracy, and
    dedication.
  </span>
  <span className="text-sm sm:text-base text-gray-600 text-center md:text-left">
    I strongly believe that medicine is not just about treating diseases, but about understanding people, building trust, and guiding them
  ...
  <div className="flex flex-col sm:flex-row gap-2 items-center justify-center md:justify-start text-sm sm:text-base">
    ...
    <div className="italic text-gray-700">Healing begins with listening.</div>
  </div>
